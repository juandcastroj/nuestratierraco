    ...
    <div className="px-6 py-32 lg:px-8 bg-[#99eeff]">
      <div className="mx-auto text-justify max-w-3xl lg:max-w-5xl text-base/7 text-blueText font-OpunMai">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="mt-4">
            Ciclo de talleres prácticos creados por y para mujeres, enfocados en
            aprender habilidades tradicionalmente asociadas a los hombres —como
            plomería, electricidad y pintura— para fortalecer la{" "}
            <strong>autonomía, confianza e independencia</strong>. Estos
            espacios promueven la igualdad y la eliminación de estereotipos de
            género desde el aprendizaje colectivo.
          </p>
