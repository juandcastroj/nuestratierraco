    ...
    <div className="relative isolate overflow-hidden w-full h-[300px] bg-cover bg-center" 
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8 ">
        <div className="mx-auto max-w-2xl py-12 sm:py-20 lg:px-12 text-center text-white hover:animate-shake animate-duration-[3000ms] animate-delay-[200ms]">
          <h1 className="text-4xl font-semibold font-BubbleboddyNeue tracking-tight text-pretty sm:text-5xl animate-flip-up">
            Nuestra Tecnología 🛠
          </h1>
          <div className="mt-6 text-xl font-semibold font-OpunMai animate-flip-down">
            <span>
            Para la comunidad, la innovación y el desarrollo sostenible.
            </span> 
                <br/>
            <span className="mt-12">
            ¡ Trabajando de la mano de <a href="https://www.preciousplastic.com/" target="_blank" rel="noopener noreferrer" className="text-2xl font-extrabold text-[#9fffcb] hover:bg-[#26dabf] underline ml-4 sm:ml-0">Precious Plastic</a>  !
            </span>
          </div>
        </div>
      </div>
