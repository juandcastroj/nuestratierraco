...
export default function PetCoinsBanner() {
  return (
    <div className="relative isolate flex items-center gap-x-6 overflow-hidden bg-[#25a18e] px-6 py-5 sm:px-5 sm:before:flex-1">
      <div
        aria-hidden="true"
      ...
      <div className="flex flex-wrap items-center gap-x-4 gap-y-2">
        <p className="text-base text-white font-semibold">
          ...
          ¡Canjea tu reciclaje por nuestros productos usando tus Petcoins!
        </p>
        <Link
          to="/login"
