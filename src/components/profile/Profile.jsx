...
export default function Profile() {
  ...
  return (
    <>
      <div className="min-h-full bg-gradient-to-b from-[#60cee5] to-[#9effca]">
        <Breadcrumbs />
        ...
        <div className="flex min-h-[60vh] bg-gradient-to-b from-[#9effca] to-[#60cee5]">
          ...
          <div className="flex flex-1 flex-col lg:flex-none px-4 py-12 sm:px-6 lg:px-32">
            <div className="flex min-h-full justify-center">
              ...
              <div className="flex flex-1 flex-col justify-center px-4 sm:px-6 lg:flex-none max-w-sm w-full mx-auto mt-8 bg-white/40 shadow-md rounded-lg overflow-hidden relative">        
